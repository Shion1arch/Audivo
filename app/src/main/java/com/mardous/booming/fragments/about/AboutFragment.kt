...
class AboutFragment : Fragment(R.layout.fragment_about), View.OnClickListener {
        ...
        when (view) {
            ...
            binding.cardAuthor.email -> {
                val emailIntent = Intent(Intent.ACTION_SENDTO).apply {
                    data = "mailto:".toUri()
                    putExtra(Intent.EXTRA_EMAIL, arrayOf("dsouradeep79@gmail.com"))
    ...
    companion object {
        private const val AUTHOR_GITHUB_URL = "https://www.github.com/Shion1arch"
        private const val GITHUB_URL = "$AUTHOR_GITHUB_URL/https://github.com/Shion1arch"
        private const val RELEASES_LINK = "$GITHUB_URL/"
        private const val ISSUE_TRACKER_LINK = "$GITHUB_URL/"
        private const val AUTHOR_TELEGRAM_LINK = "https://https://telegram.org/dl"
        private const val APP_TELEGRAM_LINK = "https://https://telegram.org/dl"
    }
}